...
// //TODO: add as a value the filepath for Nickel config
//   bool Nickel::checkFromLuaConfig(std::string value)
//   {
...
//   constexpr TLuaReturnType Nickel::getFromLuaConfig(std::string value)
//   {
