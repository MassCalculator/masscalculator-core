...
// //TODO: add as a value the filepath for Titanium config
//   bool Titanium::checkFromLuaConfig(std::string value)
//   {
...
//   constexpr TLuaReturnType Titanium::getFromLuaConfig(std::string value)
//   {
